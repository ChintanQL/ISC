			...
			{(this.state.results.length > 0) ? (
				<ul className="lisearch" >
				  {this.state.results.map(page => (
					<li key={page.node.id}>
					  <Link to={ page.node.url.replace('https://shop.nationalsportscamps.in/blog/','https://australiansportscamps.com.au/blog/')} dangerouslySetInnerHTML={{ __html: page.node.title}} ></Link>
