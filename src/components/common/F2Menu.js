							...
							return (
								<>
									...
									(
										...
										<>{(innerprop.title.replace(/\s+/g, '-').toLowerCase() == 'forms-for-coaches-and-assistants') ? (<Link to={"/asc-coaches-assistants"} className="" dangerouslySetInnerHTML={{ __html: innerprop.title}} />) : (
