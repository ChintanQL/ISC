                    ...
                    <Row>
                        <Col xl={4} lg={12} className="xl-mb-4">
                            <div className="footer-data">
                                ...
                                <p className="font-16 font-regular text-white">ASC provides the best sports coaching for Australian children and has done so for 35 years. We run structured skill-improvement camps in Australia ensuring that participants have fun whilst developing a deeper love and enthusiasm for their chosen sport.</p>
