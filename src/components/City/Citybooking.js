...
class Citybooking extends React.Component{
	...
	componentDidMount() {
		...
		var cityname = (this.props.cityname) ? this.props.cityname : "";
		
		this.setState({tags: tags})
		var url = "https://shop.nationalsportscamps.in/wp-json/newasc/v1/products";
		axios.post(url,{ Prod: products,cityname:cityname}).then(e => {
						...
						<div className="container">
							<div className="row">
								<div className="col-xl-8 col-lg-8 col-md-7 md-mb-4">
									<iframe src={"https://shop.nationalsportscamps.in/gravity-notify/?camp_state="+this.state.tags+"&camp_sports="} frameBorder="0" width="100%" height="550" ></iframe>
								</div>
