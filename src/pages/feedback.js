...
class PP extends Component {
	...
	render() {
		return (
            ...
            <>
			<Helmet>
				<title>Feedback - Australian Sports Camps</title>
				...
				<section className="Blog-Section-2">
					<Container>
						...
						<div className="Blog-Section-2-data">
							<Row>
								<iframe height="1300" width="100%" frameBorder="0" src="https://shop.australiansportscamps.com.au/gravity-feedback/" title="description" />
							</Row>
						</div>
					</Container>
