...
class CR extends Component {
	...
	componentDidMount() {
		axios({
			...
			data: {
				query: `
					query MyQuery {
						page(id: "135957", idType: DATABASE_ID) {
							id
							slug
							title
							content
	...
	render() {
		return (
            ...
            <>
			<Helmet>
				<title>Coach Recruit - Australian Sports Camps</title>
					...
					<Container>
						<div className="Banner-Section-data">
							<Breadcrumb>
								...
								<Breadcrumb.Item active href=""className="">Coach Recruit</Breadcrumb.Item>
							</Breadcrumb>
							<h2 className="heading-banner">Coach Recruit</h2>
						</div>
					</Container>
				</section>
				<section className="Blog-Section-2">
					<Container>
						...
						<div className="Blog-Section-2-data">
							<Row>
								<iframe height="850" width="100%" frameBorder="0" src="https://shop.nationalsportscamps.in/gravity-coach-recruit/" title="description" />
							</Row>
						</div>
					</Container>
				</section>
