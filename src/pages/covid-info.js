	...
	componentDidMount() {
		axios({
			...
			data: {
				query: `
					query MyQuery {
						page(id: "179835", idType: DATABASE_ID) {
							id
							slug
							title
							content
					...
					<Container>
						<div className="Banner-Section-data">
							<Breadcrumb>
								...
								<Breadcrumb.Item active href=""className="">Covid Information</Breadcrumb.Item>
							</Breadcrumb>
							<h2 className="heading-banner">Covid Information</h2>
						</div>
					</Container>
				</section>
